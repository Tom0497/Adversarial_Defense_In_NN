...
if __name__ == "__main__":
    ...
    actual_num_classes = len(dirs)  # cambiar aquí para cambiar el número de clases a usar
    images_per_class = 3            # cambiar aquí para cambiar el número de imágenes por clase a usar
        ...
        for img_dir in dirs:
            ...
            for img in images:
                if epsilon == 0:
                    ...
                    y_pred = model.predict(preprocess_input(img_adv.copy())[np.newaxis, :])
