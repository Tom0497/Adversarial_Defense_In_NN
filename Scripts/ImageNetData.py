...
from Scripts.DataExtractor import *
...
def unpickle(path, number_of_classes, images_per_class):
    """
...
class ImageNetData:
    ...
    def __init__(self, number_of_classes=5, images_per_class=200, batch_size=100, validation_proportion=0.1,
        ...
        # Training set
        d = unpickle(DIR_BINARIES, number_of_classes, images_per_class)
        ...
        self.train_labels = labels_to_one_hot(self.train_labels, number_of_classes)
        self.validation_labels = labels_to_one_hot(self.validation_labels, number_of_classes)
        self.test_labels = labels_to_one_hot(self.test_labels, number_of_classes)
...
if __name__ == '__main__':
    imageNet8 = ImageNetData(batch_size=4, img_size=224)
